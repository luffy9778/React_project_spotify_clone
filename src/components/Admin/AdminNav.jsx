...
const AdminNav = () => {
  ...
  return (
    <div className="h-1/6 bg-slate-900 flex justify-evenly items-center ">
      <div
        className="bg-yellow-600 w-36 rounded-lg text-center py-4 "
      ...
      <div
        className="bg-red-600 w-36 rounded-lg text-center py-4 "
      ...
      <div
        className="bg-lime-600 w-36 rounded-lg text-center py-4 "
      ...
      <div
        className="bg-orange-600 w-36 rounded-lg text-center py-4 "
